...
<div>总数：${pageHolder.rowCount}
  ...
  <input type="button" value="go" onclick="var pageIndex=$e('pageIndex').value;if(!pageIndex)return false;this.disabled=true;location.href='?${pageHolder.pageIndexKey}='+pageIndex+'${pageHolder.params}'"/>
