...
if ($.fn.validatebox){
	...
	$.fn.validatebox.defaults.rules.email.message = 'Introdu?u una adre?a de correu electrònic vàlida.';
	$.fn.validatebox.defaults.rules.url.message = 'Si us plau, introdu?u un URL vàlida.';
