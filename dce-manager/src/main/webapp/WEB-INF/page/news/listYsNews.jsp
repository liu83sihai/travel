...
<script type="text/javascript" src="<c:url value='/js/news/ysnews.js?v='/>"></script>
...
<div id="body" region="center" > 
  <!-- 查询条件区域 -->
	<div id="search_areaYsNews"  class="easyui-panel" >
		<div id="conditon" >
  	...
  	<!-- 数据表格区域 -->
  <div id="tt_YsNews"></div>
  
</div>

  <div id="editYsNewsDiv"></div>  
</body>
