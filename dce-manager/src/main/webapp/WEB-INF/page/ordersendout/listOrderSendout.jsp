...
<script type="text/javascript" src="<c:url value='/js/ordersendout/ordersendout.js?v='/>"></script>
...
<div id="body" region="center" > 
  <!-- 查询条件区域 -->
	<div id="search_areaOrderSendout"  class="easyui-panel" >
		<div id="conditon" >
			<form id="searchorderSendoutForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
			          	<td class="tdfont" colspan="2">发货时间:
  	...
  	<!-- 数据表格区域 -->
  <div id="tt_OrderSendout"></div>
  
</div>

  <div id="editOrderSendoutDiv"></div>  
</body>
