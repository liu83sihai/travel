...
<script type="text/javascript" src="<c:url value='/js/banner/banner.js'/>?v=12${jsversion}"></script>
...
<div id="body" region="center" > 
  <!-- 查询条件区域
	<div id="search_areaBanner"  class="easyui-panel" >
		<div id="conditon" >
			<form id="searchbannerForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
   ...
   -->
  	<!-- 数据表格区域 -->
  <div id="tt_Banner"></div>
  
</div>

  <div id="editBannerDiv"></div>  
</body>
