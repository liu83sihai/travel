...
<script type="text/javascript" src="<c:url value='/js/menuAdmin/index.js'/>"></script>
	<style type="text/css">
		.tdfont {
			font-size: 12px;
		}
	...
	<div id="conditon" >
		<form id="searchForm" style="margin-top:7px;margin-left:5px;">
			<table border="0">
				<tr>
					<td class="tdfont">名字:
						<input type="text" size="14" id="menuName"></td>
					<td colspan="2">
						...
						<a href="javascript:void(0)" id="resetButton" class="easyui-linkbutton" iconCls="icon-reset"
						   plain="true">重置</a>
						<a href="javascript:void(0)" id="addButton" class="easyui-linkbutton" iconCls="icon-add"
						   plain="true">增加</a>
					</td>
				</tr>
			</table>
...
<script type="text/javascript">
    ...
    $("#searchButton").on("click", function () {
        ...
        $("#tableGrid").datagrid('load', {
            'name': encodeURIComponent($("#searchForm #menuName").val()),
        });
    });

    $("#addButton").on("click",function () {

        window.adminMenu.addNew();
    })
</script>
</body>
</html>