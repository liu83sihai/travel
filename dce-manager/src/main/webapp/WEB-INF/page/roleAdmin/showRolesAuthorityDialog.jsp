	...
	<div class="easyui-layout" style="width:1000px;height:350px;">
		...
		<div data-options="region:'east',split:true,iconCls:'icon-ok'"
			...
			<table class="easyui-datagrid" id="hasAdd" pagination="true"
				...
				data-options="url:'${basePath }/homemng/menuAdmin/authoritiesInRolesOrNot.action?roleId=${role.id }&inRoleOrNot=1&pageSize=10',method:'get',border:false,singleSelect:true,fit:true,fitColumns:true
		...
		<div data-options="region:'center',title:'未加入权限'">
			<table id="unAdd" class="easyui-datagrid" pagination="true"
				striped="true" rownumbers="true" fitColumns="true"
				data-options="url:'${basePath }/homemng/menuAdmin/authoritiesInRolesOrNot.action?roleId=${role.id }&inRoleOrNot=2&pageSize=10',method:'get',border:false,singleSelect:true,fit:true,fitColumns:true
