...
<body>
	<table style="margin-left: auto;margin-right: auto;border-collapse:separate; border-spacing:10px;width:100%">
		<tr>
            <td style="font-size:16px;">中心账户编码:</td>
            <td><input type="text" class="easyui-validatebox" style="width:100%;height:30px;font-size:16px;" id="centerAccount" name="centerAccount">
            </td>
        </tr>
        <tr>
            <td style="font-size:16px;">中心账户密码:</td>
            <td><input type="text" class="easyui-validatebox" style="width:100%;height:30px;font-size:16px;" id="centerPassword" name="centerPassword">
            </td>
        </tr>
	</table>
</body>
