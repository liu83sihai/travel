...
<script type="text/javascript" src="<c:url value='/js/etherenum/ethere_index.js?v=${jsversion}'/>"></script>
			...
			<form id="searchForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
						...
						<td class="tdfont">以太坊账户:<input type="text" size="14" id="account" name="account" placeholder="以太坊账户" style="width:300px;"></td>
