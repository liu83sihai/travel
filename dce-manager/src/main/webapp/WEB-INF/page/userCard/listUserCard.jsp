...
<script type="text/javascript" src="<c:url value='/js/userCard/userCard.js'/>"></script>
...
<div id="body" region="center" > 
  <!-- 查询条件区域 -->
	<div id="search_areaUserCard"  class="easyui-panel" >
		<div id="conditon" >
			<form id="searchuserCardForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
			          <td class="tdfont">查询条件:
			          	<input type="text" size="14" id="searchStr" name="searchStr" placeholder="用户名" >
			          	<input type="text" size="14" id="searchCodeStr" name="searchCodeStr" placeholder="手机号码" >
			          </td>
			          <td >
  	...
  	<!-- 数据表格区域 -->
  <div id="tt_UserCard"></div>
  
</div>

  <div id="editUserCardDiv"></div>  
</body>
