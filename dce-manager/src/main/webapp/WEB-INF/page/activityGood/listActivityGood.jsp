...
<script type="text/javascript" src="<c:url value='/js/activitygood/activitygood.js?v='/>"></script>
...
<div id="body" region="center" > 
  <!-- 查询条件区域 -->
	<div id="search_areaActivityGood"  class="easyui-panel" >
		<div id="conditon" >
			<form id="searchactivityGoodForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
  	...
  	<!-- 数据表格区域 -->
  <div id="tt_ActivityGood"></div>
  
</div>

  <div id="editActivityGoodDiv"></div>  
</body>
