...
@Controller
@RequestMapping("/ethertrans")
public class EtherenumTransController extends BaseAction {

	@Resource
	private IEthereumTransInfoService ethereumTransInfoService;
	
	@RequestMapping("/index")
	public String index(){
		return "/etherenum/trans_index";
	}
	...
	public void list(Pagination<Map<String,Object>> pagination,
		...
		try {
			...
			PageDo<Map<String,Object>> usersList = ethereumTransInfoService.selectEthTransByPage(page, params);
