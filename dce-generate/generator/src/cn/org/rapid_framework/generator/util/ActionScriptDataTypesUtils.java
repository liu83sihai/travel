...
public class ActionScriptDataTypesUtils {
	...
	static {
		...
		preferredAsTypeForJavaType.put("java.lang.Short", "BIGINT");
		preferredAsTypeForJavaType.put("short", "BIGINT");
		preferredAsTypeForJavaType.put("java.lang.Integer", "BIGINT");
		preferredAsTypeForJavaType.put("int", "BIGINT");
		preferredAsTypeForJavaType.put("java.lang.Long", "BIGINT");
		preferredAsTypeForJavaType.put("long", "BIGINT");
