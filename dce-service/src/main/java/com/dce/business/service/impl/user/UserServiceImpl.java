...
public class UserServiceImpl implements IUserService {
	...
	// // 获取修改用户的ID
	// if (StringUtils.isNotBlank(String.valueOf(userDo.getId()))) {
	...
	//
	// // 认证状态
	// if (userDo.getTrueName() != null || userDo.getMobile() != null ||
	// userDo.getIdnumber() != null
	...
	// return result > 0 ? Result.successResult("service：修改成功!") :
	// Result.failureResult("service：修改失败");
	// }
	// return flag;
	// }
