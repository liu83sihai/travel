           ...
           <div class="col-xs-12 col-sm-6 col-md-12">
               <div class="panel panel-default">
                   <div class="panel-heading">
                       <i class="fa fa-cubes"></i>我要升级
                   </div>
                   <div class="panel-body">
                       <table class="table table-responsive">
	                       <tbody>
	                       		<tr>
                               		<td align="right">升级用户:</td>
                               		<td>
                               		 <input type="hidden" name="userId" id="userId" value="${user.id }"/>
                                  	 <input type="text" class="form-bonus-set" name="userCode" id="userCode" value="${user.trueName==null?user.mobile:user.trueName}" style="widht:200px;">
                                    </td>
                               </tr>
                               <tr>
                                   <td align="right">升级级别:</td>
                                   <td>
...
<input type="button" value="提交" id="saveButton">
<script>
