...
public class CalculateUtils {
     ...
     * @return 两个参数的和
     */
    public static double addCeil(double v1, double v2) {
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
        return Math.ceil(b1.add(b2).doubleValue());
    }
     ...
     * @return
     */
    public static boolean isLessAndEqual(double v1, double v2) {
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
        return (b1.compareTo(b2) == 0 || b1.compareTo(b2) == -1);
    }
    ...
    public static double splitByRate(double baseVal, double numeratorVal, double denominatorVal) {
        if (eq(baseVal, 0))
            return 0;
        if (eq(denominatorVal, 0))
            return 0;
        if (eq(numeratorVal, 0))
            return 0;
