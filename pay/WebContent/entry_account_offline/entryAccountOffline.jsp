  ...
  <body>
      ...
      <form id="form" action="https://zgateway.kjtpay.com/recv.do" method="post">
		...
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				<td>接口名称:</td>
				<td><input type="text" id="service" name="service" value="entry_account_offline"></td>
				<td>(例如：entry_account_offline，非空)</td>
			</tr>
			<tr>
				<td>接口版本:</td>
	...
	<div id='bizContentDiv'>
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				<td>快捷通会员ID:</td>
				<td><input type="text" name="member_id" value="200000055673"></td>
				<td>(非空)</td>
			</tr>
			<tr>
				<td>业务产品码:</td>
				<td><input type="text" name="biz_product_code" value="30101"></td>
				<td>(非空)</td>
			</tr>
			<tr>
				<td>服务器异步通知地址:</td>
