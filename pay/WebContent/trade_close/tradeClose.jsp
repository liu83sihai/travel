  ...
  <body>
      ...
      <form id="form" action="https://zgateway.kjtpay.com/recv.do" method="post">
		...
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			<tr>
				<th colspan="3">以下是请求公共参数，点[交易提交]按钮后将提交到快捷通网关</th>	
			</tr>
			<tr>
			...
			<tr>
				<td>接口名称:</td>
				<td><input type="text" id="service" name="service" value="trade_close"></td>
				<td>(例如：trade_close，非空)</td>
			</tr>
			<tr>
				<td>接口版本:</td>
			...
			<tr>
				<td colspan="3"><input type="button" id="submitBtn" value="交易提交" /></td>
			</tr>
		</table>	
    </form>
    </div>
	...
	<div id='bizContentDiv'>
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				...
				<td width="15%"><input type="text" name="out_trade_no" value=""></td>
				<td>(字母数字下划线，与快捷通交易订单号(trade_no)二选一)</td>
			</tr>
			<tr>
				<td>快捷通交易订单号:</td>
				<td><input type="text" name="trade_no" value=""></td>
				<td>(字母数字下划线，与平台(商户)订单号(out_trade_no)二选一)</td>
			</tr>
		</table>
	</div>
