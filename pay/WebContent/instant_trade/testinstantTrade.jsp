...
<html>
  ...
  <body>
      ...
      <div>
      <form id="form" action="https://c1gateway.kjtpay.com/recv.do" method="post">
		...
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				<td>合作者身份ID:</td>
				<td><input type="text" name="partner_id" value="200000151629"></td>
			...
			<tr>
				<td>签名方式:</td>
				<td><input type="text" id="sign_type" name="sign_type" value="RSA"></td>
	...
	<div id='bizContentDiv'>
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
				...
				<td>(根据不同的业务场景选择合适的支付方式，可空)
					...
					<span>
						...
						<select id='payMethodSelect'>
							<option selected="selected" value=''>使用快捷通收银台进行支付</option>
							<option value='{"pay_product_code":"20","amount":"0.19","bank_code":"ABC"}'>直接跳转到目标银行网银页面支付(如跳转农行网银)</option>
			...
			<tr>
				<td>收银台类型:</td>
				<td><input type="text" name="cashier_type" value='H5'></td>
			...
			<tr>
				<td>商户自定义域:</td>
				<td><input type="text" name="merchant_custom" value='{"go_cashier":"Y","need_login":"N"}'></td>
	...
	<div id='tradeInfoDiv'>
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				<td>卖家会员ID或登入账号:</td>
				<td><input type="text" name="payee_identity" value='200000151629'></td>
				<td>(非空)</td>
			</tr>
			<tr>
				<td>业务号:</td>
