  ...
  <body>
      ...
      <form id="form" action="https://zgateway.kjtpay.com/recv.do" method="post">
		...
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				<td>接口名称:</td>
				<td><input type="text" id="service" name="service" value="transfer_to_account"></td>
	...
	<div id='bizContentDiv'>
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				...
				<td>(入款快捷通会员标识类型，默认1，1-快捷通会员ID，2-快捷通会员登入号，可空)</td>
			</tr>
			<tr>
				<td>转账金额:</td>
				<td><input type="text" name="transfer_amount" value='0.98'></td>
			...
			<tr>
				<td>业务号:</td>
				<td><input type="text" name="biz_no" value='K2017062209512800001234'></td>
				<td>(业务号，对账用，可空)</td>
			</tr>
			<tr>
				<td>服务器异步通知页面地址:</td>
