  ...
  <body>
      ...
      <form id="form" action="https://zgateway.kjtpay.com/recv.do" method="post">
		...
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			<tr>
				<th colspan="3">以下是请求公共参数，点[交易查询]按钮后将提交到快捷通网关</th>	
			</tr>
			<tr>
			...
			<tr>
				<td>接口名称:</td>
				<td><input type="text" id="service" name="service" value="trade_query"></td>
			...
			<tr>
				<td colspan="3"><input type="button" id="submitBtn" value="交易查询" /></td>
			</tr>
		</table>	
    </form>
    </div>
